...
<img src="https://raw.githubusercontent.com/YonierGomez/ai-locker/main/docs/promptly.png" alt="AI Locker" width="100%" style="max-width:900px;border-radius:12px;" />

**AI Locker** — A beautiful, self-hosted web app to manage your AI prompts, skills, steering configurations, MCP server setups, and shell commands. **Includes built-in AI Chat** to generate prompts, skills, steering rules, MCP configs, and commands from natural language.
